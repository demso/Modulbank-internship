...
/// <summary>
    /// Обработчик команды
    /// </summary>
    public class PerformTransactionHandler(IAccountsRepositoryAsync accountsRepository, ITransactionsRepositoryAsync transactionsRepository , IMapper mapper) 
        : BaseRequestHandler<PerformTransactionCommand, TransactionDto>
    {
        /// <inheritdoc />
